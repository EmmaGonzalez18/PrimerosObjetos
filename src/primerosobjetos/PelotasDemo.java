...
public class PelotasDemo   
{
    ...
    public PelotasDemo()
    {
        miCanvas = new Canvas("Java", 600, 500);
    ...
    public void demoDibujar()
    {
        ...
        miCanvas.setColorDeLapiz(Color.gray);miCanvas.setColorDeLapiz(Color.red);
    ...
    public void rebotar()
    {
        ...
        ReboteDePelota pelota = new ReboteDePelota(50, 50, 16, Color.pink, piso, miCanvas);
        pelota.dibujar();
        ReboteDePelota pelota2 = new ReboteDePelota(70, 80, 20, Color.gray, piso, miCanvas);
        pelota2.dibujar();
